...
// NIP v3.0 — Operator Surface (M8) — Client component
...
//
// NOTE: This is wrapped by src/app/page.tsx (a server component) so that
// `export const dynamic = "force-dynamic"` can be applied to the route,
// preventing Vercel from serving stale prerendered HTML.
